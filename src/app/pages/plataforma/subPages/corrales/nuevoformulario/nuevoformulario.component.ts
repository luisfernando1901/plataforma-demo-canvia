...
export class NuevoformularioComponent implements OnInit {
  ...
  answersFormCACN = this.fb.group({
    ...
    MVZ_CACN: [],
    MVZ_RA_SUPERVISOR: [],
    numero_de_cabezas_ingresadas_al_CACN: [],
    cabezas_engordadas: [],
    cabezas_egresadas_del_CACN_para_sacrificio_en_rastros: [],
    numero_cabezas_muertas_en_el_CACN: [],
    numero_cabezas_en_el_CACN_ultimo_dia_mes_evaluacion: [],
  ...
  answersFormCE = this.fb.group({
    ...
    numero_de_cabezas_ingresadas_al_CE: [],
    cabezas_engordadas: [],
    cabezas_egresadas_del_CE_para_sacrificio_en_rastros: [],
    numero_cabezas_muertas_en_el_CE: [],
    numero_cabezas_en_el_CE_ultimo_dia_mes_evaluacion: [],
